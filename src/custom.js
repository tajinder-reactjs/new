...
const RowRenderer = rowDropTarget(
  rowDragSource((props) => {
    const {
      isOver,
      children,
...
class CustomRendererSheet extends PureComponent {
    ...
    this.state = {
      ...
      grid: [
        ...
        [
          ...
          { value: "30 - 45" },
          { value: "6 - 14" },
          { value: 5, dataEditor: RangeEditor, valueViewer: FillViewer },
        ],
        [
          { value: "Scottish Light" },
          { value: "9 - 20" },
          { value: "6 - 15" },
          { value: 3, dataEditor: SelectEditor, valueViewer: FillViewer },
        ],
        [
          { value: "Scottish Heavy" },
          { value: "12 - 20" },
          { value: "8 - 30" },
          { value: 4, dataEditor: SelectEditor },
        ],
        [
        ...
        [
          ...
          { value: "20 - 30" },
          { value: "3 - 7" },
          { value: 3, dataEditor: SelectEditor },
        ],
        [
  ...
  renderRow(props) {
    ...
    return (
      <RowRenderer rowIndex={row} onRowDrop={this.handleRowDrop} {...rest} />
    );
  }
